...
/* user/new.html.twig */
class __TwigTemplate_8e8e5c878913f181c6210f0867e7b3f858377a8de326ea0a35c2c9e277c36234 extends Template
{
    private $source;
    private $macros = [];
...
\t\t</div>
  \t\t<legend>";
        // line 39
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("admin.create_user", [], "messages");
        echo "</legend>
...
\t\t\t</div>\t\t\t
\t\t</div>
  \t\t<legend>{% trans %} admin.create_user {% endtrans %}</legend>
...
\t    </div>
 ...
 ", "user/new.html.twig", "/home/julio/book_management/templates/user/new.html.twig");
    }
}
