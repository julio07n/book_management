...
$catalogue = new MessageCatalogue('es', array (
  ...
  'messages' => 
  array (
    'reserve.success' => 'Reserva realizada.',
    'reserve.delete' => 'Reserva eliminada.',
    'reserve.book_reserved' => 'El libro seleccionado ha sido reservado por otro usuario.',
    'admin.create_user' => 'Crear usuario',
    'admin.edit_user' => 'Editar usuario',
    'admin.delete_user' => 'Eliminar usuario',
    'admin.create_library' => 'Crear biblioteca',
    'admin.edit_library' => 'Editar biblioteca',
    'admin.delete_library' => 'Eliminar biblioteca',
    'admin.create_book' => 'Crear libro',
    'admin.edit_book' => 'Editar libro',
    'admin.delete_book' => 'Eliminar libro',
    'admin.created_success' => 'Registro creado exitosamente.',
    'admin.edited_success' => 'Registro editado exitosamente.',
    'admin.deleted_success' => 'Registro eliminado exitosamente.',
    'admin.csv' => 'Descargar CSV',
    'notificacion.es.success_reserve' => 'Libro reservado correctamente',
    'notificacion.es.remember_reservation_subject' => 'Recordatorio: Reserva de libro por finalizar',
    'notificacion.es.remember_reservation_body' => 'La reserva del libro <strong>book</strong> finalizará el día date_end.',
    'notificacion.ca.success_reserve' => 'Llibre reservat correctament',
    'notificacion.ca.remember_reservation_subject' => 'Recordatori: Reserva de llibre por finalitzar',
    'notificacion.ca.remember_reservation_body' => 'La reserva de el llibre <strong>book</strong> finalitzarà el dia date_end.',
    'notificacion.book_not_available_email.subject' => 'Libro solicitado más de una vez',
    'notificacion.book_not_available_email.text' => 'Libro solicitado más de una vez',
    'notificacion.book_not_available_email.body' => 'El siguiente libro ha sido solicitado más de una vez.',
    'menu.usuario' => 'Usuario',
    'menu.password' => 'Contraseña',
    'menu.cerrar_sesion' => 'Cerrar',
    'menu.usuarios' => 'Usuarios',
    'menu.bibliotecas' => 'Bibliotecas',
    'menu.libros' => 'Libros',
    'menu.reservar' => 'Reservar libro',
    'menu.mis_reservas' => 'Mis reservas',
    'back' => 'Volver',
    'save' => 'Guardar',
    'new' => 'Nuevo',
  ),
